...
import com.bluesunshine.douban4droid.model.subject.DoubanSubjectFeedObj;
import com.bluesunshine.douban4droid.model.subject.DoubanSubjectObj;
import com.bluesunshine.douban4droid.model.v2.DoubanSubjectListObj;
...
public class DoubanBookMovieMusicService extends DoubanService {
  ...
  public com.bluesunshine.douban4droid.model.v2.DoubanSubjectObj getV2MovieInfoById(long movieId) throws DoubanException, IOException {
    String url = RequestUrls.DOUBAN_MOVIE_V2_SUBJECT_PREFIX + "/" + movieId;
    com.bluesunshine.douban4droid.model.v2.DoubanSubjectObj movie = this.client.getResponseInJson(url, null, com.bluesunshine.douban4droid.model.v2.DoubanSubjectObj.class, false);
    return movie;
  }
